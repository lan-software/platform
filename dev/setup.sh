...
echo "  cd LanCore     && cp .env.example .env && vendor/bin/sail up -d"
echo "  cd LanBrackets && cp .env.example .env && vendor/bin/sail up -d"
echo "  cd LanShout    && cp .env.example .env && vendor/bin/sail up -d"
echo "  cd LanHelp     && cp .env.example .env && vendor/bin/sail up -d"
echo "  cd LanEntrance && cp .env.example .env && vendor/bin/sail up -d"
echo ""
